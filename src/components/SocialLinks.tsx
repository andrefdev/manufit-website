...
const SocialLinks: React.FC<{ page?: string }> = ({ page }) => {
  ...
  return (
    <>
      ...
      <div className="hidden fixed right-10 bottom-0 md:flex flex-col w-6 h-[14rem] items-center justify-between z-50">
        ...
        <div className="w-40 h-1 bg-white dark:bg-bglight rotate-90"></div>
      </div>
    </>
  );
};
...
const socialLinks = [
  {
    id: 1,
    title: "manufit instagram",
    link: "https://www.instagram.com/themanufit/",
    svg: (
      <svg
        ...
        height="24"
        fill="white"
        className="h-5 w-5 hover:fill-customPrimary"
      >
  ...
  {
    id: 2,
    title: "manufit whatsapp",
    link: "https://api.whatsapp.com/send?phone=51912172568",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 308 308"
        width="24"
        height="24"
        className="w-5 h-5 ml-[2px] fill-white hover:fill-customPrimary"
      >
        <path
          id="XMLID_469_"
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        width="24"
        height="24"
        className="fill-white hover:fill-customPrimary dark:hover:fill-carrigreen"
      >
